...
<nav class="navbar navbar-expand-lg navbar-dark"><a class="navbar-brand" href="#">${user.nome} ${user.cognome}</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active"> <a class="nav-link" onclick="loadingModal()" href="./homeMedicoSpecialista.jsp">Home <span class="sr-only">(current)</span></a> </li>
...
<div class="container text-center">
  <div class="card">
    <div class="card-img"> <img src="../images/people.jpg" alt="people" style="height:220px;">
      <div class="overlay">
        <div class="overlay-content"> <a onclick="loadingModal()"  href="./pazientiMedicoSpecialista">Vai al parco pazienti provinciale</a> </div>
      </div>
    </div>
    <div class="card-content"> <a  onclick="loadingModal()"  href="./pazientiMedicoSpecialista">
      <h2>Pazienti provinciali</h2>
      <p>Tutti i pazienti della tua provincia</p>
      </a> </div>
  </div>
  <div class="card">
    <div class="card-img"> <img src="../images/calendar.jpg" alt="pills" style="height:220px;">
      <div class="overlay">
      <form id="formPlanning" action="CalendarioVisiteSpecialista"  ></form>
        <div class="overlay-content"> <a onclick="loadingModal();" href="./CalendarioVisiteSpecialista">Vai al planning</a> </div>
      </div>
    </div>
    <div class="card-content"><a type="submit" onclick="loadingModal();" href="./CalendarioVisiteSpecialista" >
      <h2>Visite ed esami</h2>
      <p>Tutte le visite e gli esami in programma</p>
      </a> </div>
  </div>
</div>
<hr>
