...
<nav class="navbar navbar-expand-lg navbar-dark"><a class="navbar-brand" href="#">${user.nome} ${user.cognome}</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active"><a class="nav-link"  onclick="loadingModal()" href="CalendarioVisiteBase" role="button" aria-haspopup="true" aria-expanded="false"> Visite</a> </li>
