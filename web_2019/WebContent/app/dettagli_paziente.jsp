  ...
  <div class="container">
    <div class="media">
      <div class="media-body text-center" style="background-color:  "> <img class="rounded-circle " src="images/utente1img.jpg" width="150" height="150" alt="user">
        ...
        <div class="container" style="border-radius: 20px; background-color: #F2F2F2; padding-bottom: 10px; padding-top: 10px;">
          <h4>Nome medico</h4>
          <hr>
          <h4>Telefono: </h4>
          <hr>
          <a class="btn btn-success" href="#">Prenota visita</a> </div>
      </div>
    </div>
  </div>
</div>
...
<div class="container text-center">
  <div class="card">
    <div class="card-img"> <img src="images/pills.jpg" alt="pills" style="height:220px;">
      <div class="overlay">
        <div class="overlay-content"> <a class="hover" href="#!">Vai alle ricette</a> </div>
      </div>
    </div>
  ...
  <div class="card">
    <div class="card-img"> <img src="images/exam.jpg" alt="pills" style="height:220px;">
      <div class="overlay">
        <div class="overlay-content"> <a href="#!">Vai agli esami</a> </div>
      </div>
    </div>
    <div class="card-content"> <a href="#!">
      <h2>Esami</h2>
...
<hr>
<script id="rendered-js" src="js/card_hover.js"></script> 
