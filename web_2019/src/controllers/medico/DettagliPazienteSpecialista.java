 ...
 *  
 */
@WebServlet("/medico/DettagliPazienteSpecalista")
public class DettagliPazienteSpecialista extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/medico/pazienteMedicoSpecialista.jsp");
