...
public class AggiungiEsame extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (id_esami!= null && paziente != null) {
			if(visita_corrente == null) {
				visita_corrente = new VisitaCorrente();
				request.getSession().setAttribute("visita_corrente", new VisitaCorrente());
			}
			System.out.println(visita_corrente);
			System.out.println(id_esami.length);
			visita_corrente.aggiungiEsame(id_esami);
