 ...
 *  
 */
@WebServlet("/medico/EsamiPaziente")
public class EsamiPazienteMedicoBase extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/medico/esamiPazienteMedicoBase.jsp");
