 ...
 */
@WebServlet("/paziente/scegliStrutturaVisita")
public class ModalPrenotaVisita extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

		int id_prenotazione = Integer.parseInt(request.getParameter("id_prenotazione"));
		String nome_struttura = request.getParameter("nome_struttura");
		
		
		JsonArray result = new MedicoDAO().getJsonMediciVisita(id_prenotazione,nome_struttura);
