 ...
 */
@WebServlet("/paziente/modalPrenotaEsame")
public class ScegliStrutturaEsame extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		JsonArray result = new MedicoDAO().getJsonStruttureEsame(id_prenotazione,provincia);
