 ...
 */
@WebServlet("/paziente/scegliStruttura")
public class ModalPrenotaEsame extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		JsonArray result = new MedicoDAO().getJsonMediciEsame(id_prenotazione,nome_struttura);
